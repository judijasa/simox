...
function insert_empleos(PDO $conn, array $rows, int $batch_size): void
{
    ...
    foreach ($rows as $row) {
        ...
        $insert_rows[] = [
            ...
            isset($empleo['sinCodigo']) ? (int)$empleo['sinCodigo'] : null,
            $den_lookup->fetchColumn() ?: null,
            $empleo['descripcion'] ?? null,
            isset($empleo['concursoAscenso']) ? (int)$empleo['concursoAscenso'] : null,
            isset($empleo['condicionDiscapacidad']) ? (int)$empleo['condicionDiscapacidad'] : null,
            ...
            isset($empleo['urbano']) ? (int)$empleo['urbano'] : null,
            isset($empleo['aeronautico']) ? (int)$empleo['aeronautico'] : null,
            isset($empleo['noCobroOpec']) ? (int)$empleo['noCobroOpec'] : null,
...
// #[CronJob(schedule: '0 5 * * *', scope: 'worker')]
